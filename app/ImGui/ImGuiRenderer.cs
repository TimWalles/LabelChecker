...
namespace LabelChecker
{
    ...
    public class ImGuiRenderer
    {
        ...
        {
            var io = ImGui.GetIO();
            Enable(ref io.ConfigWindowsMoveFromTitleBarOnly);
            ...
            //};
            ///////////////////////////////////////////
            if ((int)Environment.OSVersion.Platform == 4 || (int)Environment.OSVersion.Platform == 6)
            {
                _customFont = io.Fonts.AddFontFromFileTTF(Path.Combine(System.AppContext.BaseDirectory, "Content/fonts/SEGUIBL.TTF"), 20f);
            }
            else
            {
                _customFont = io.Fonts.AddFontFromFileTTF(Path.Combine(Environment.CurrentDirectory, "Content/fonts/SEGUIBL.TTF"), 20f);
            }
